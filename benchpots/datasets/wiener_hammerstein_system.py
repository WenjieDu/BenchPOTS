"""
Preprocessing func for the dataset Wiener Hammerstein System Benchmark.
...
def preprocess_wiener_hammerstein_system(
    rate,
    n_steps,
    pattern: str = "point",
    **kwargs,
) -> dict:
    """Load and preprocess the dataset Wiener Hammerstein System Benchmark.
    ...
    -------
    processed_dataset :
        A dictionary containing the processed Wiener Hammerstein System Benchmark.
    """
